...
function App() {
  ...
  // Brand splash: shows on every launch, auto-dismisses after ~2s + fade.
      ...
      {showSplash && (
        <div className="splash" aria-hidden="true">
          <svg
            ...
            viewBox="0 0 512 512"
          >
            <g fill="#FFFEFD" transform="translate(-880.5 -169.8) scale(0.789)">
          ...
          <p className="splash-word">LEKKER ADEMEN</p>
        </div>
      )}
      <audio
        ref={musicAudioRef}
